...
static PyTypeObject *
__Pyx_ImportType(PyObject *module, const char *module_name,
...
static CYTHON_INLINE
    __pyx_t_float_complex __Pyx_c_neg_float(__pyx_t_float_complex);
static CYTHON_INLINE int __Pyx_c_is_zero_float(__pyx_t_float_complex);
static CYTHON_INLINE
    __pyx_t_float_complex __Pyx_c_conj_float(__pyx_t_float_complex);
#if 1
...
static CYTHON_INLINE
    __pyx_t_double_complex __Pyx_c_neg_double(__pyx_t_double_complex);
static CYTHON_INLINE int __Pyx_c_is_zero_double(__pyx_t_double_complex);
static CYTHON_INLINE
    __pyx_t_double_complex __Pyx_c_conj_double(__pyx_t_double_complex);
#if 1
...
__Pyx_PyInt_From_unsigned_int(unsigned int value);
...
static PyArrayObject *__pyx_f_4bbox_bbox_overlaps_c(PyArrayObject *,
                                                    PyArrayObject *); /*proto*/
static PyArrayObject *
__pyx_f_4bbox_bbox_intersections_c(PyArrayObject *, PyArrayObject *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t = {
    "DTYPE_t", NULL, sizeof(__pyx_t_4bbox_DTYPE_t), {0}, 0, 'R', 0, 0};
...
static PyObject *
__pyx_pf_4bbox_bbox_overlaps(CYTHON_UNUSED PyObject *__pyx_self,
                             PyObject *__pyx_v_boxes,
                             PyObject *__pyx_v_query_boxes); /* proto */
static PyObject *
__pyx_pf_4bbox_2bbox_intersections(CYTHON_UNUSED PyObject *__pyx_self,
                                   PyObject *__pyx_v_boxes,
                                   PyObject *__pyx_v_query_boxes); /* proto */
 ...
 *
 * def bbox_overlaps(boxes, query_boxes):             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=2] boxes_contig =
 * np.ascontiguousarray(boxes, dtype=DTYPE) cdef np.ndarray[DTYPE_t, ndim=2]
 * query_contig = np.ascontiguousarray(query_boxes, dtype=DTYPE)
 */
...
static PyMethodDef __pyx_mdef_4bbox_1bbox_overlaps = {
    "bbox_overlaps",
    (PyCFunction)(void *)(PyCFunctionWithKeywords)__pyx_pw_4bbox_1bbox_overlaps,
...
static PyObject *__pyx_pw_4bbox_1bbox_overlaps(PyObject *__pyx_self,
  ...
  __Pyx_RefNannyDeclarations __Pyx_RefNannySetupContext(
      "bbox_overlaps (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_boxes,
                                            &__pyx_n_s_query_boxes, 0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      case 1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(
                        __pyx_kwds, __pyx_n_s_query_boxes)) != 0))
          kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bbox_overlaps", 1, 2, 2, 1);
...
__pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bbox_overlaps", 1, 2, 2,
                             PyTuple_GET_SIZE(__pyx_args));
  __PYX_ERR(0, 15, __pyx_L3_error)
__pyx_L3_error:;
  __Pyx_AddTraceback("bbox.bbox_overlaps", __pyx_clineno, __pyx_lineno,
                     __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
__pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4bbox_bbox_overlaps(__pyx_self, __pyx_v_boxes,
                                         __pyx_v_query_boxes);
...
__pyx_pf_4bbox_bbox_overlaps(CYTHON_UNUSED PyObject *__pyx_self,
   ...
   * def bbox_overlaps(boxes, query_boxes):
   *     cdef np.ndarray[DTYPE_t, ndim=2] boxes_contig =
   * np.ascontiguousarray(boxes, dtype=DTYPE)             # <<<<<<<<<<<<<< cdef
   * np.ndarray[DTYPE_t, ndim=2] query_contig =
   * np.ascontiguousarray(query_boxes, dtype=DTYPE)
   *
   */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_ascontiguousarray);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_DTYPE);
  if (unlikely(!__pyx_t_4))
    __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_4) < 0)
    __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4);
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_1, __pyx_t_3);
  if (unlikely(!__pyx_t_4))
    __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(
                     &__pyx_pybuffernd_boxes_contig.rcbuffer->pybuffer,
                     (PyObject *)__pyx_t_5,
                     &__Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t,
                     PyBUF_FORMAT | PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_boxes_contig = ((PyArrayObject *)Py_None);
      __Pyx_INCREF(Py_None);
      __pyx_pybuffernd_boxes_contig.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 16, __pyx_L1_error)
    } else {
      __pyx_pybuffernd_boxes_contig.diminfo[0].strides =
          __pyx_pybuffernd_boxes_contig.rcbuffer->pybuffer.strides[0];
      __pyx_pybuffernd_boxes_contig.diminfo[0].shape =
          __pyx_pybuffernd_boxes_contig.rcbuffer->pybuffer.shape[0];
      __pyx_pybuffernd_boxes_contig.diminfo[1].strides =
          __pyx_pybuffernd_boxes_contig.rcbuffer->pybuffer.strides[1];
      __pyx_pybuffernd_boxes_contig.diminfo[1].shape =
          __pyx_pybuffernd_boxes_contig.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_5 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_ascontiguousarray);
  if (unlikely(!__pyx_t_3))
    __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4);
  ...
  if (unlikely(!__pyx_t_1))
    __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_DTYPE);
  if (unlikely(!__pyx_t_2))
    __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_2) < 0)
    __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2);
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, __pyx_t_1);
  if (unlikely(!__pyx_t_2))
    __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3);
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_2);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(
                     &__pyx_pybuffernd_query_contig.rcbuffer->pybuffer,
                     (PyObject *)__pyx_t_6,
                     &__Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t,
                     PyBUF_FORMAT | PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_query_contig = ((PyArrayObject *)Py_None);
      __Pyx_INCREF(Py_None);
      __pyx_pybuffernd_query_contig.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 17, __pyx_L1_error)
    } else {
      __pyx_pybuffernd_query_contig.diminfo[0].strides =
          __pyx_pybuffernd_query_contig.rcbuffer->pybuffer.strides[0];
      __pyx_pybuffernd_query_contig.diminfo[0].shape =
          __pyx_pybuffernd_query_contig.rcbuffer->pybuffer.shape[0];
      __pyx_pybuffernd_query_contig.diminfo[1].strides =
          __pyx_pybuffernd_query_contig.rcbuffer->pybuffer.strides[1];
      __pyx_pybuffernd_query_contig.diminfo[1].shape =
          __pyx_pybuffernd_query_contig.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_6 = 0;
  ...
  /* "bbox.pyx":19
   *     cdef np.ndarray[DTYPE_t, ndim=2] query_contig =
   * np.ascontiguousarray(query_boxes, dtype=DTYPE)
   *
   *     return bbox_overlaps_c(boxes_contig, query_contig)             #
   * <<<<<<<<<<<<<<
  ...
  __pyx_t_2 = ((PyObject *)__pyx_f_4bbox_bbox_overlaps_c(
      ((PyArrayObject *)__pyx_v_boxes_contig),
      ((PyArrayObject *)__pyx_v_query_contig)));
  if (unlikely(!__pyx_t_2))
 ...
 *
 * cdef np.ndarray[DTYPE_t, ndim=2] bbox_overlaps_c(             #
 * <<<<<<<<<<<<<< np.ndarray[DTYPE_t, ndim=2] boxes, np.ndarray[DTYPE_t, ndim=2]
 * query_boxes):
 */

static PyArrayObject *
__pyx_f_4bbox_bbox_overlaps_c(PyArrayObject *__pyx_v_boxes,
                              PyArrayObject *__pyx_v_query_boxes) {
  ...
  __pyx_pybuffernd_query_boxes.rcbuffer = &__pyx_pybuffer_query_boxes;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(
                     &__pyx_pybuffernd_boxes.rcbuffer->pybuffer,
                     (PyObject *)__pyx_v_boxes,
                     &__Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t,
                     PyBUF_FORMAT | PyBUF_STRIDES, 2, 0, __pyx_stack) == -1))
      __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_pybuffernd_boxes.diminfo[0].strides =
      __pyx_pybuffernd_boxes.rcbuffer->pybuffer.strides[0];
  __pyx_pybuffernd_boxes.diminfo[0].shape =
      __pyx_pybuffernd_boxes.rcbuffer->pybuffer.shape[0];
  __pyx_pybuffernd_boxes.diminfo[1].strides =
      __pyx_pybuffernd_boxes.rcbuffer->pybuffer.strides[1];
  __pyx_pybuffernd_boxes.diminfo[1].shape =
      __pyx_pybuffernd_boxes.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(
                     &__pyx_pybuffernd_query_boxes.rcbuffer->pybuffer,
                     (PyObject *)__pyx_v_query_boxes,
                     &__Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t,
                     PyBUF_FORMAT | PyBUF_STRIDES, 2, 0, __pyx_stack) == -1))
      __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_pybuffernd_query_boxes.diminfo[0].strides =
      __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.strides[0];
  __pyx_pybuffernd_query_boxes.diminfo[0].shape =
      __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.shape[0];
  __pyx_pybuffernd_query_boxes.diminfo[1].strides =
      __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.strides[1];
  __pyx_pybuffernd_query_boxes.diminfo[1].shape =
      __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.shape[1];
   ...
   *     cdef np.ndarray[DTYPE_t, ndim=2] overlaps = np.zeros((N, K),
   * dtype=DTYPE)
   */
   ...
   *     cdef unsigned int K = query_boxes.shape[0]             # <<<<<<<<<<<<<<
   *     cdef np.ndarray[DTYPE_t, ndim=2] overlaps = np.zeros((N, K),
   * dtype=DTYPE) cdef DTYPE_t iw, ih, box_area
   */
  ...
  __Pyx_DECREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_N);
  if (unlikely(!__pyx_t_1))
    __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_K);
  if (unlikely(!__pyx_t_3))
    __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  if (unlikely(!__pyx_t_4))
    __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_DTYPE);
  if (unlikely(!__pyx_t_1))
    __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_1) < 0)
    __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1);
  __pyx_t_1 = 0;
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(
                     &__pyx_pybuffernd_overlaps.rcbuffer->pybuffer,
                     (PyObject *)__pyx_t_5,
                     &__Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t,
                     PyBUF_FORMAT | PyBUF_STRIDES | PyBUF_WRITABLE, 2, 0,
                     __pyx_stack) == -1)) {
      __pyx_v_overlaps = ((PyArrayObject *)Py_None);
      __Pyx_INCREF(Py_None);
      __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 35, __pyx_L1_error)
    } else {
      __pyx_pybuffernd_overlaps.diminfo[0].strides =
          __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.strides[0];
      __pyx_pybuffernd_overlaps.diminfo[0].shape =
          __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.shape[0];
      __pyx_pybuffernd_overlaps.diminfo[1].strides =
          __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.strides[1];
      __pyx_pybuffernd_overlaps.diminfo[1].shape =
          __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_5 = 0;
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8 += 1) {
    ...
    if (unlikely(__pyx_t_9 >=
                 (size_t)__pyx_pybuffernd_query_boxes.diminfo[0].shape))
      __pyx_t_11 = 0;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_pybuffernd_query_boxes.diminfo[1].shape;
      if (unlikely(__pyx_t_10 < 0))
        __pyx_t_11 = 1;
    } else if (unlikely(__pyx_t_10 >=
                        __pyx_pybuffernd_query_boxes.diminfo[1].shape))
      __pyx_t_11 = 1;
    ...
    __pyx_v_box_area =
        ((((*__Pyx_BufPtrStrided2d(
               __pyx_t_4bbox_DTYPE_t *,
               __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_9,
               __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_10,
               __pyx_pybuffernd_query_boxes.diminfo[1].strides)) -
           (*__Pyx_BufPtrStrided2d(
               __pyx_t_4bbox_DTYPE_t *,
               __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_12,
               __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_13,
               __pyx_pybuffernd_query_boxes.diminfo[1].strides))) +
          1.0) *
         (((*__Pyx_BufPtrStrided2d(
               __pyx_t_4bbox_DTYPE_t *,
               __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_14,
               __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_15,
               __pyx_pybuffernd_query_boxes.diminfo[1].strides)) -
           (*__Pyx_BufPtrStrided2d(
               __pyx_t_4bbox_DTYPE_t *,
               __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_16,
               __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_17,
               __pyx_pybuffernd_query_boxes.diminfo[1].strides))) +
          1.0));
    ...
    for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20 += 1) {
      ...
      __pyx_t_21 = (*__Pyx_BufPtrStrided2d(
          __pyx_t_4bbox_DTYPE_t *,
          __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_16,
          __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_17,
          __pyx_pybuffernd_query_boxes.diminfo[1].strides));
      ...
      __pyx_t_11 = -1;
      if (unlikely(__pyx_t_16 >=
                   (size_t)__pyx_pybuffernd_boxes.diminfo[0].shape))
        __pyx_t_11 = 0;
      if (__pyx_t_17 < 0) {
      ...
      __pyx_t_22 = (*__Pyx_BufPtrStrided2d(
          __pyx_t_4bbox_DTYPE_t *,
          __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_16,
          __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_17,
          __pyx_pybuffernd_boxes.diminfo[1].strides));
      ...
      if (__pyx_t_25) {
        ...
        __pyx_t_24 = (*__Pyx_BufPtrStrided2d(
            __pyx_t_4bbox_DTYPE_t *,
            __pyx_pybuffernd_query_boxes.rcbuffer->pybuffer.buf, __pyx_t_16,
            __pyx_pybuffernd_query_boxes.diminfo[0].strides, __pyx_t_17,
            __pyx_pybuffernd_query_boxes.diminfo[1].strides));
        ...
        __pyx_t_23 = (*__Pyx_BufPtrStrided2d(
            __pyx_t_4bbox_DTYPE_t *,
            __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf, __pyx_t_16,
            __pyx_pybuffernd_boxes.diminfo[0].strides, __pyx_t_17,
            __pyx_pybuffernd_boxes.diminfo[1].strides));
        ...
        if (__pyx_t_25) {
           ...
           */
          __pyx_v_ua =
              ((double)((((((*__Pyx_BufPtrStrided2d(
                                __pyx_t_4bbox_DTYPE_t *,
                                __pyx_pybuffernd_boxes.rcbuffer->pybuffer.buf,
                                __pyx_t_16,
                                __pyx_pybuffernd_boxes.diminfo[0].strides,
                                __pyx_t_17,
                                __pyx_pybuffernd_boxes.diminfo[1].strides)) -
          ...
          __pyx_t_11 = -1;
          if (unlikely(__pyx_t_9 >=
                       (size_t)__pyx_pybuffernd_overlaps.diminfo[0].shape))
            __pyx_t_11 = 0;
          if (unlikely(__pyx_t_12 >=
                       (size_t)__pyx_pybuffernd_overlaps.diminfo[1].shape))
            __pyx_t_11 = 1;
          if (unlikely(__pyx_t_11 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_11);
            __PYX_ERR(0, 60, __pyx_L1_error)
          ...
          *__Pyx_BufPtrStrided2d(
              __pyx_t_4bbox_DTYPE_t *,
              __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.buf, __pyx_t_9,
              __pyx_pybuffernd_overlaps.diminfo[0].strides, __pyx_t_12,
              __pyx_pybuffernd_overlaps.diminfo[1].strides) =
              (__pyx_t_22 / __pyx_v_ua);
...
__pyx_L1_error:;
  ...
  __Pyx_AddTraceback("bbox.bbox_overlaps_c", __pyx_clineno, __pyx_lineno,
                     __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
__pyx_L0:;
...
/* Python wrapper */
static PyObject *
__pyx_pw_4bbox_3bbox_intersections(PyObject *__pyx_self, PyObject *__pyx_args,
                                   PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4bbox_3bbox_intersections = {
    "bbox_intersections",
...
static PyObject *__pyx_pw_4bbox_3bbox_intersections(PyObject *__pyx_self,
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      case 1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(
          ...
          __Pyx_RaiseArgtupleInvalid("bbox_intersections", 1, 2, 2, 1);
  ...
  goto __pyx_L4_argument_unpacking_done;
__pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bbox_intersections", 1, 2, 2,
                             PyTuple_GET_SIZE(__pyx_args));
  __PYX_ERR(0, 64, __pyx_L3_error)
__pyx_L3_error:;
  __Pyx_AddTraceback("bbox.bbox_intersections", __pyx_clineno, __pyx_lineno,
                     __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
__pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4bbox_2bbox_intersections(__pyx_self, __pyx_v_boxes,
                                               __pyx_v_query_boxes);
...
__pyx_pf_4bbox_2bbox_intersections(CYTHON_UNUSED PyObject *__pyx_self,
   ...
   */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = ((PyObject *)__pyx_f_4bbox_bbox_intersections_c(
      ((PyArrayObject *)__pyx_v_boxes_contig),
      ((PyArrayObject *)__pyx_v_query_contig)));
  if (unlikely(!__pyx_t_2))
...
static PyArrayObject *
__pyx_f_4bbox_bbox_intersections_c(PyArrayObject *__pyx_v_boxes,
                                   PyArrayObject *__pyx_v_query_boxes) {
  unsigned int __pyx_v_N;
  unsigned int __pyx_v_K;
   ...
   *     cdef unsigned int N = boxes.shape[0]             # <<<<<<<<<<<<<<
   *     cdef unsigned int K = query_boxes.shape[0]
   *     cdef np.ndarray[DTYPE_t, ndim=2] intersec = np.zeros((N, K),
   * dtype=DTYPE)
   */
  __pyx_v_N = (__pyx_v_boxes->dimensions[0]);
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(
                     &__pyx_pybuffernd_intersec.rcbuffer->pybuffer,
                     (PyObject *)__pyx_t_5,
                     &__Pyx_TypeInfo_nn___pyx_t_4bbox_DTYPE_t,
                     PyBUF_FORMAT | PyBUF_STRIDES | PyBUF_WRITABLE, 2, 0,
                     __pyx_stack) == -1)) {
      __pyx_v_intersec = ((PyArrayObject *)Py_None);
      __Pyx_INCREF(Py_None);
      __pyx_pybuffernd_intersec.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 87, __pyx_L1_error)
    } else {
      __pyx_pybuffernd_intersec.diminfo[0].strides =
          __pyx_pybuffernd_intersec.rcbuffer->pybuffer.strides[0];
      __pyx_pybuffernd_intersec.diminfo[0].shape =
          __pyx_pybuffernd_intersec.rcbuffer->pybuffer.shape[0];
      __pyx_pybuffernd_intersec.diminfo[1].strides =
          __pyx_pybuffernd_intersec.rcbuffer->pybuffer.strides[1];
      __pyx_pybuffernd_intersec.diminfo[1].shape =
          __pyx_pybuffernd_intersec.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_5 = 0;
    ...
    for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20 += 1) {
      ...
      if (__pyx_t_25) {
        ...
        if (__pyx_t_25) {
          ...
          __pyx_t_11 = -1;
          if (unlikely(__pyx_t_16 >=
                       (size_t)__pyx_pybuffernd_intersec.diminfo[0].shape))
            __pyx_t_11 = 0;
          if (unlikely(__pyx_t_14 >=
                       (size_t)__pyx_pybuffernd_intersec.diminfo[1].shape))
            __pyx_t_11 = 1;
          if (unlikely(__pyx_t_11 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_11);
            __PYX_ERR(0, 107, __pyx_L1_error)
          ...
          *__Pyx_BufPtrStrided2d(
              __pyx_t_4bbox_DTYPE_t *,
              __pyx_pybuffernd_intersec.rcbuffer->pybuffer.buf, __pyx_t_16,
              __pyx_pybuffernd_intersec.diminfo[0].strides, __pyx_t_14,
              __pyx_pybuffernd_intersec.diminfo[1].strides) =
...
__pyx_L1_error:;
  ...
  __Pyx_AddTraceback("bbox.bbox_intersections_c", __pyx_clineno, __pyx_lineno,
                     __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
__pyx_L0:;
 ...
 *
 * cdef inline object PyArray_MultiIterNew4(a, b, c, d):             #
 * <<<<<<<<<<<<<< return PyArray_MultiIterNew(4, <void*>a, <void*>b, <void*>c,
 * <void*> d)
 *
 */
 ...
 *
 * cdef inline object PyArray_MultiIterNew5(a, b, c, d, e):             #
 * <<<<<<<<<<<<<< return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c,
 * <void*> d, <void*> e)
 *
 */
...
static CYTHON_INLINE PyObject *
__pyx_f_5numpy_PyDataType_SHAPE(PyArray_Descr *__pyx_v_d) {
  PyObject *__pyx_r = NULL;
 ...
 * <<<<<<<<<<<<<< Py_INCREF(base) # important to do this before stealing the
 * reference below! PyArray_SetBaseObject(arr, base)
 */
...
__pyx_f_5numpy_set_array_base(PyArrayObject *__pyx_v_arr,
   ...
   * below!             # <<<<<<<<<<<<<< PyArray_SetBaseObject(arr, base)
   *
   */
...
static CYTHON_INLINE int __pyx_f_5numpy_import_array(void) {
   ...
   */
  {
    ...
    /*try:*/ {
      ...
      if (unlikely(__pyx_t_4 == ((int)-1)))
        __PYX_ERR(1, 943, __pyx_L3_error)
  ...
  __pyx_L3_error:;
    ...
    if (__pyx_t_4) {
      __Pyx_AddTraceback("numpy.import_array", __pyx_clineno, __pyx_lineno,
                         __pyx_filename);
       ...
       */
      __pyx_t_8 =
          __Pyx_PyObject_Call(__pyx_builtin_ImportError, __pyx_tuple_, NULL);
...
static CYTHON_INLINE int __pyx_f_5numpy_import_umath(void) {
   ...
   */
  {
    ...
    /*try:*/ {
      ...
      if (unlikely(__pyx_t_4 == ((int)-1)))
        __PYX_ERR(1, 949, __pyx_L3_error)
  ...
  __pyx_L3_error:;
    ...
    __pyx_t_4 = __Pyx_PyErr_ExceptionMatches(
        ((PyObject *)(&((PyTypeObject *)PyExc_Exception)[0])));
    if (__pyx_t_4) {
      __Pyx_AddTraceback("numpy.import_umath", __pyx_clineno, __pyx_lineno,
                         __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_5, &__pyx_t_6, &__pyx_t_7) < 0)
       ...
       */
      __pyx_t_8 =
          __Pyx_PyObject_Call(__pyx_builtin_ImportError, __pyx_tuple__2, NULL);
      if (unlikely(!__pyx_t_8))
...
static CYTHON_INLINE int __pyx_f_5numpy_import_ufunc(void) {
   ...
   */
  {
    ...
    /*try:*/ {
      ...
      __pyx_t_4 = _import_umath();
      if (unlikely(__pyx_t_4 == ((int)-1)))
        __PYX_ERR(1, 955, __pyx_L3_error)
  ...
  __pyx_L3_error:;
    ...
    __pyx_t_4 = __Pyx_PyErr_ExceptionMatches(
        ((PyObject *)(&((PyTypeObject *)PyExc_Exception)[0])));
    if (__pyx_t_4) {
      __Pyx_AddTraceback("numpy.import_ufunc", __pyx_clineno, __pyx_lineno,
                         __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_5, &__pyx_t_6, &__pyx_t_7) < 0)
...
static CYTHON_INLINE int
__pyx_f_5numpy_is_timedelta64_object(PyObject *__pyx_v_obj) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations __Pyx_RefNannySetupContext("is_timedelta64_object",
                                                        0);
...
static CYTHON_INLINE int
__pyx_f_5numpy_is_datetime64_object(PyObject *__pyx_v_obj) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations __Pyx_RefNannySetupContext("is_datetime64_object",
                                                        0);
...
static CYTHON_INLINE npy_datetime
__pyx_f_5numpy_get_datetime64_value(PyObject *__pyx_v_obj) {
...
static CYTHON_INLINE npy_timedelta
__pyx_f_5numpy_get_timedelta64_value(PyObject *__pyx_v_obj) {
...
static CYTHON_INLINE NPY_DATETIMEUNIT
__pyx_f_5numpy_get_datetime64_unit(PyObject *__pyx_v_obj) {
   ...
   */
  __pyx_r =
      ((NPY_DATETIMEUNIT)((PyDatetimeScalarObject *)__pyx_v_obj)->obmeta.base);
  goto __pyx_L0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_n_s_ImportError, __pyx_k_ImportError, sizeof(__pyx_k_ImportError),
     0, 0, 1, 1},
    {&__pyx_n_s_ascontiguousarray, __pyx_k_ascontiguousarray,
     sizeof(__pyx_k_ascontiguousarray), 0, 0, 1, 1},
    {&__pyx_n_s_bbox, __pyx_k_bbox, sizeof(__pyx_k_bbox), 0, 0, 1, 1},
    {&__pyx_n_s_bbox_intersections, __pyx_k_bbox_intersections,
     sizeof(__pyx_k_bbox_intersections), 0, 0, 1, 1},
    {&__pyx_n_s_bbox_overlaps, __pyx_k_bbox_overlaps,
     sizeof(__pyx_k_bbox_overlaps), 0, 0, 1, 1},
    {&__pyx_kp_s_bbox_pyx, __pyx_k_bbox_pyx, sizeof(__pyx_k_bbox_pyx), 0, 0, 1,
     0},
    {&__pyx_n_s_boxes, __pyx_k_boxes, sizeof(__pyx_k_boxes), 0, 0, 1, 1},
    {&__pyx_n_s_boxes_contig, __pyx_k_boxes_contig,
     sizeof(__pyx_k_boxes_contig), 0, 0, 1, 1},
    ...
    {&__pyx_n_s_query_boxes, __pyx_k_query_boxes, sizeof(__pyx_k_query_boxes),
     0, 0, 1, 1},
    {&__pyx_n_s_query_contig, __pyx_k_query_contig,
     sizeof(__pyx_k_query_contig), 0, 0, 1, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitCachedConstants(void) {
   ...
   * cdef inline int import_umath() except -1:
   */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_numpy_core_multiarray_failed_to);
   ...
   * cdef inline int import_ufunc() except -1:
   */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_numpy_core_umath_failed_to_impor);
   ...
   * query_contig = np.ascontiguousarray(query_boxes, dtype=DTYPE)
   */
  __pyx_tuple__3 = PyTuple_Pack(4, __pyx_n_s_boxes, __pyx_n_s_query_boxes,
                                __pyx_n_s_boxes_contig, __pyx_n_s_query_contig);
  if (unlikely(!__pyx_tuple__3))
    __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_codeobj__4 = (PyObject *)__Pyx_PyCode_New(
      2, 0, 4, 0, CO_OPTIMIZED | CO_NEWLOCALS, __pyx_empty_bytes,
      __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple,
      __pyx_empty_tuple, __pyx_kp_s_bbox_pyx, __pyx_n_s_bbox_overlaps, 15,
      __pyx_empty_bytes);
   ...
   * query_contig = np.ascontiguousarray(query_boxes, dtype=DTYPE)
   */
  __pyx_tuple__5 = PyTuple_Pack(4, __pyx_n_s_boxes, __pyx_n_s_query_boxes,
                                __pyx_n_s_boxes_contig, __pyx_n_s_query_contig);
  if (unlikely(!__pyx_tuple__5))
    __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__5);
  __Pyx_GIVEREF(__pyx_tuple__5);
  __pyx_codeobj__6 = (PyObject *)__Pyx_PyCode_New(
      2, 0, 4, 0, CO_OPTIMIZED | CO_NEWLOCALS, __pyx_empty_bytes,
      __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__5, __pyx_empty_tuple,
      __pyx_empty_tuple, __pyx_kp_s_bbox_pyx, __pyx_n_s_bbox_intersections, 64,
      __pyx_empty_bytes);
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_7cpython_4type_type =
      __Pyx_ImportType(__pyx_t_1, __Pyx_BUILTIN_MODULE_NAME, "type",
...
__pyx_pymod_exec_bbox(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  __Pyx_RefNannyDeclarations
    ...
    PyErr_SetString(PyExc_RuntimeError,
                    "Module 'bbox' has already been imported. "
...
/*--- Module creation code ---*/
...
#else
#if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("bbox", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  Py_XINCREF(__pyx_m);
#else
...
#if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "bbox")) {
      if (unlikely(PyDict_SetItemString(modules, "bbox", __pyx_m) < 0))
        __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
#endif
...
/*--- Execution code ---*/
  ...
  __Pyx_DECREF(__pyx_t_1);
  __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE, __pyx_t_2) < 0)
    __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2);
  __pyx_t_2 = 0;
   ...
   */
  __pyx_t_2 =
      PyCFunction_NewEx(&__pyx_mdef_4bbox_1bbox_overlaps, NULL, __pyx_n_s_bbox);
  if (unlikely(!__pyx_t_2))
    __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bbox_overlaps, __pyx_t_2) < 0)
    __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2);
  __pyx_t_2 = 0;
   ...
   * query_contig = np.ascontiguousarray(query_boxes, dtype=DTYPE)
   */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4bbox_3bbox_intersections, NULL,
                                __pyx_n_s_bbox);
  if (unlikely(!__pyx_t_2))
    __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bbox_intersections, __pyx_t_2) < 0)
    __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2);
  __pyx_t_2 = 0;
...
__pyx_L1_error:;
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bbox", __pyx_clineno, __pyx_lineno,
                         __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
...
static size_t __Pyx_BufFmt_TypeCharToStandardSize(char ch, int is_complex) {
  ...
  case 'g': {
    PyErr_SetString(PyExc_ValueError,
                    "Python does not define a standard format string size for "
                    "long double ('g')..");
    return 0;
  }
  case 'O':
...
static PyObject *__pyx_buffmt_parse_array(__Pyx_BufFmt_Context *ctx,
                                          const char **tsp) {
  const char *ts = *tsp;
  int i = 0, number, ndim;
  ++ts;
...
#pragma GCC diagnostic pop
  ...
  }
  {
    ...
    return _PyLong_FromByteArray(bytes, sizeof(unsigned int), little,
                                 !is_unsigned);
  }
}
...
#pragma GCC diagnostic pop
  ...
  if (likely(PyInt_Check(x))) {
    ...
    if (is_unsigned) {
      ...
      case 1:
        __PYX_VERIFY_RETURN_INT(unsigned int, digit, digits[0])
      case 2:
        if (8 * sizeof(unsigned int) > 1 * PyLong_SHIFT) {
          if (8 * sizeof(unsigned long) > 2 * PyLong_SHIFT) {
            ...
            return (unsigned int)(((((unsigned int)digits[1]) << PyLong_SHIFT) |
      ...
      case 3:
        if (8 * sizeof(unsigned int) > 2 * PyLong_SHIFT) {
          if (8 * sizeof(unsigned long) > 3 * PyLong_SHIFT) {
            ...
            return (
                unsigned int)(((((((unsigned int)digits[2]) << PyLong_SHIFT) |
      ...
      case 4:
        if (8 * sizeof(unsigned int) > 3 * PyLong_SHIFT) {
          if (8 * sizeof(unsigned long) > 4 * PyLong_SHIFT) {
            ...
            return (
                unsigned int)(((((((((unsigned int)digits[3]) << PyLong_SHIFT) |
      ...
      if (sizeof(unsigned int) <= sizeof(unsigned long)) {
        __PYX_VERIFY_RETURN_INT_EXC(unsigned int, unsigned long,
                                    PyLong_AsUnsignedLong(x))
#ifdef HAVE_LONG_LONG
      } else if (sizeof(unsigned int) <= sizeof(unsigned PY_LONG_LONG)) {
        __PYX_VERIFY_RETURN_INT_EXC(unsigned int, unsigned PY_LONG_LONG,
      ...
      case 0:
        return (unsigned int)0;
      case -1:
        __PYX_VERIFY_RETURN_INT(unsigned int, sdigit,
          ...
          if (8 * sizeof(unsigned long) > 2 * PyLong_SHIFT) {
            ...
            return (
                unsigned int)(((unsigned int)-1) *
                              (((((unsigned int)digits[1]) << PyLong_SHIFT) |
                                (unsigned int)digits[0])));
          }
        }
        break;
      case 2:
        if (8 * sizeof(unsigned int) > 1 * PyLong_SHIFT) {
          if (8 * sizeof(unsigned long) > 2 * PyLong_SHIFT) {
            ...
            return (
                unsigned int)((((((unsigned int)digits[1]) << PyLong_SHIFT) |
                                (unsigned int)digits[0])));
          }
        }
        break;
      case -3:
        if (8 * sizeof(unsigned int) - 1 > 2 * PyLong_SHIFT) {
          if (8 * sizeof(unsigned long) > 3 * PyLong_SHIFT) {
            ...
            return (
                unsigned int)(((unsigned int)-1) *
                              (((((((unsigned int)digits[2]) << PyLong_SHIFT) |
                                  (unsigned int)digits[1])
                                 << PyLong_SHIFT) |
                                (unsigned int)digits[0])));
          }
      ...
      case 4:
        if (8 * sizeof(unsigned int) > 3 * PyLong_SHIFT) {
          if (8 * sizeof(unsigned long) > 4 * PyLong_SHIFT) {
            ...
            return (unsigned int)((
                ((((((((unsigned int)digits[3]) << PyLong_SHIFT) |
                     (unsigned int)digits[2])
                    << PyLong_SHIFT) |
                   (unsigned int)digits[1])
                  << PyLong_SHIFT) |
      ...
      if (sizeof(unsigned int) <= sizeof(long)) {
        ...
        __PYX_VERIFY_RETURN_INT_EXC(unsigned int, PY_LONG_LONG,
                                    PyLong_AsLongLong(x))
#endif
      }
    }
